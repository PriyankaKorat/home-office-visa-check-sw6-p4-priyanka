...
public class VisaConfirmationFeatureSteps {
    ...
    public void iSelectReason() {
        new ReasonOfTravelPage().selectTheOptionForVisitWorkAcademicVisit();
    }

    @And("I click on continue next button")
    public void iClickOnContinueNextButton() {
        new ReasonOfTravelPage().clickOnContinueButtonForReasonForTravelling();
    }
    ...
    public void iSelectReasonTourism(String reason) {
        new ReasonOfTravelPage().selectReasonForVisitWithReason(reason);
    }
    ...
    public void iSelectReasonJoinPartnerOrFamilyForALongStay() {
        new ReasonOfTravelPage().selectTheOptionForVisitJoinPartnerOrFamilyForALongStay();
    }
